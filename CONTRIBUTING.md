...
1. Fill in the publish form:
   ...
   - **Cover image** (optional) — one PNG or JPEG, up to 1 MB and 2048px a side, shown on the hub site, in-game, and on the plugin's Discord thread. It goes through the same review as everything else: see the image rules in [docs/AUTHORING.md](docs/AUTHORING.md).
