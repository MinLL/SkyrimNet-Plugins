...
function routeOrFail() {
  ...
  // Pure triggers/prompts/knowledge — agent review path. Knowledge packs do NOT
  // force a human: the agent reviewer already knows how to scan .sknpack entries
  // (see .github/agent-review-prompt.md), and a pack's content is prose in the
  // same class as a prompt. Only actions force manual review.
